...
from .models import School, Domain, PlatformSettings, SubscriptionPlan
...
class SchoolAdmin(TenantAdminMixin, admin.ModelAdmin):
    list_display = ("name", "schema_name", "code", "plan", "trial_end_date", "subscription_plan", "created_on", "is_active")
